function fish_prompt
  ...
  set -l uwu1 (set_color DF8A94)
  set -l uwu2 (set_color FF00E2)
  set -l uwu3 (set_color FF36AF)
  ...
  ## Line 1
  ##
  echo -n $uwu1'╭─ '$uwu2$current_user$uwu1' at '$uwu2$__fish_prompt_hostname$uwu1' in '$uwu3(pwd|sed "s=$HOME=家=")$turquoise
  __fish_git_prompt " (%s)"
  echo
  ...
  ## Rest of the prompt
  ##
  echo -n $uwu1'─ '$uwu3$__fish_prompt_char $normal
end
